...
if( ! function_exists( 'woodmart_enqueue_scripts' ) ) {
    ...
    function woodmart_enqueue_scripts() {
        ...
        $translations = array(
            ...
            'countdown_days' => esc_html__('дн', 'woodmart'),
            'countdown_hours' => esc_html__('час', 'woodmart'),
            'countdown_mins' => esc_html__('мин', 'woodmart'),
            'countdown_sec' => esc_html__('сек', 'woodmart'),
