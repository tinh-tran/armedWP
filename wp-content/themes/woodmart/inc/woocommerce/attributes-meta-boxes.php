...
if( ! function_exists( 'woodmart_wc_attribute_add' ) ) {
	...
	function woodmart_wc_attribute_add( $attribute_id, $attribute ) {
		add_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_swatch_size', $_POST['attribute_swatch_size'] );

		add_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_show_on_product', $_POST['attribute_show_on_product'] );
	}
}
