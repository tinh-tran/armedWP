    ...
    <div class="container">
        <div class="anchor__wrapper">
            <ul class="anchor__inner">
                ...
                <li class="anchor__item"><a class="anchor__item-link" href="#">Видео</a></li>
                <li class="anchor__item"><a class="anchor__item-link" href="#">Характеристики</a></li>
                <li class="anchor__item"><a class="anchor__item-link" href="#">Состав комплекта</a></li>
                <li class="anchor__item"><a class="anchor__item-link" href="#">Описание товара</a></li>
                <li class="anchor__item"><a class="anchor__item-link" href="#">Отзывы</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="single-product_wrapper">
    <div class="single-product_content col-sm-8">
        <?php
            /**
    ...
    <div class="single-product_fixed col-sm-4">
        <div class="single-product_fixed-wrapper">
            ...
            <?php
                ...
                // NOTICE! Understand what this does before running.
                $result = woocommerce_template_single_sharing();
            ?>
        </div>
    </div>
</div>
