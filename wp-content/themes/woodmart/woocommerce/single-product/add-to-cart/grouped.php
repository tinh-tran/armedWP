...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table shop_table_responsive">
		<tbody>
			<?php
				...
				foreach ( $grouped_products as $grouped_product ) {
					...
					<tr id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<?php $attachment_id = get_post_meta( $grouped_product->get_id(), '_thumbnail_id', true ); ?>

						<td class="product-thumbnail grouped-thumb">
