	...
	switch($p_type){
		...
		case 'twocheckout':
			...
			if ($arr['ihc_twocheckout_api_user'] != '' && $arr['ihc_twocheckout_api_pass'] != '' 
				...
				&& $arr['ihc_twocheckout_secret_word'] != '' ) $return['settings'] = 'Завершено';
			break;
		case 'bank_transfer':
			...
			<div class="ihc-coupon-box-main">
				...
				<div class="ihc-coupon-box-links-wrap">
					<div class="ihc-coupon-box-links">
						<a href="<?php echo $url . '&id=' . $id;?>" class="ihc-coupon-box-link">Редактировать</a>
						<div class="ihc-coupon-box-link" onClick="ihc_delete_coupon(<?php echo $id;?>, '#<?php echo $div_id;?>');">Удалить</div>
					</div>
				</div>
			</div>
