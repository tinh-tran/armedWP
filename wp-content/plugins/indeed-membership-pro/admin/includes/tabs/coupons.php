						...
						<?php 
							if ($_GET['subtab']=='multiple_coupons'){
								...
								<div class="iump-form-line">
									...
									<input type="text" value="<?php echo $meta_arr['code'];?>" name="code" id="ihc_the_coupon_code" /> <span style="font-size: 11px;color: #fff; padding: 6px 9px;-webkit-border-radius: 3px;box-radius: 3px;    background-color: rgba(240, 80, 80, 0.8);cursor: pointer;" onClick="ihc_generate_code('#ihc_the_coupon_code', 10);"><?php _e("Generate Code", "ihc");?></span>
								</div>								
								<?php 
							}
						?>
