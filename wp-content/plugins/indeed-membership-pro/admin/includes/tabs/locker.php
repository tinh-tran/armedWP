...
<?php 
	...
	if ($subtab=='add_new'){
			...
			<form method="post" action="<?php echo $url.'&tab='.$tab.'&subtab=lockers_list';?>">
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">	
						<div class="iump-form-line iump-no-border">
							<?php 
								$templates = array(1=>'По умолчанию', 2=>'Основные', 3=>'Zipped', 4=>'Зона', 5=>'MAJIC прозрачный', 6=>'Звезда', 7=>'Облачно', 8=>'Тёмный');
							?>
		...
		<span class="ihc-top-message"><?php _e('...Создайте шаблоны Замка для дальнейшего использования!', 'uap');?></span>
						...
						foreach($templates as $k=>$v){
							...
							<tr class="<?php if($i%2==0) echo 'alternate';?>">
								...
								<span class="subcr-type-list">
									<?php 
									$templates = array(1=>'По умолчанию', 2=>'Основные', 3=>'Zipped', 4=>'Зона', 5=>'Majic Прозрачный', 6=>'Звезда', 7=>'Облачно', 8=>'Кофе со сливками');
		...
		<?php 
			...
			?>
				<div class="ihc-warning-message"> <?php _e('Нет шаблонов доступных! Пожалуйста, создайте ваш первый внутренний замок.', 'ihc');?></div> 
			<?php 	
		}
	}
?>
