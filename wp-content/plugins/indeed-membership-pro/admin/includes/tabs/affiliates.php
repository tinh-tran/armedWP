		...
		<div class="ihc-stuffbox" style="padding:20px 20px;">
			<h2>
				<label style=" font-size:16px; color:##B70B0B;">
					Чтобы получить этот раздел доступен <a href="http://codecanyon.net/item/ultimate-affiliate-pro-wordpress-plugin/16527729" target="_blank">Ultimate Партнерская Pro</a> система должна быть активирована на вашем WordPress системы.
				</label>
			</h2>		
			<p style="max-width:750px;"><strong>Ultimate Партнерская Pro</strong> является новейшим и наиболее завершено Партнерская WordPress плагин, который позволит вам обеспечить платформу премиум для ваших филиалов с различные награды и суммы, основанные на ряды или специальные предложения.
			<br/>Вы можете включить ваш сайт в реальный бизнес и доходы машина где вам просто нужно сесть и пусть другие работы для вас!
			</p>
			...
			<br/><h2>Вы можете найти более подробную информацию <a href="http://www.wpripper.ru/partnyorskaya-pro-plagin-wordpress/" target="_blank">Здесь</a></h2>
			</p>
