...
function ihc_locker_meta_keys(){
	...
	$arr = array(
					'ihc_locker_name' => 'Замок Без названия ',
	...
	switch ($type){
		...
		case 'payment_bank_transfer':
			$arr = array(
					...
					'ihc_bank_transfer_message' => '<p>Привет {username},</p>
<br/>
<p>Пожалуйста продолжите оплату банковским переводом : {currency}{amount}</p>

<p><strong>Платежные реквизиты:</strong> Подписка {level_name} для {username} с идентификацией: {user_id}_{level_id}</p>

<br/>

<strong>Банковские реквизиты:</strong><br/>

IBAN:xxxxxx-WPRIPPER.RU-xxxxx<br/>
...
НАЗВАНИЕ банка<br/>',
		...
		case 'login-messages':
			$arr = array(
							...
							'ihc_login_pending' => 'Ваш счет не был утвержден. Пожалуйста повторите попытку позже',
							'ihc_login_error' => 'Недопустимый Email Адрес или пароль',
							'ihc_reset_msg_pass_err' => 'Недопустимый Email Адрес или имя пользователя ',
							'ihc_reset_msg_pass_ok' => 'Новый пароль был отправлен ваш email адрес',	
							'ihc_login_error_email_pending' => 'E-mail адрес еще не был проверен',
							'ihc_login_error_on_captcha' => 'Captcha Ошибка',
							'ihc_login_error_ajax' => 'Пожалуйста Заполните все необходимые поля!',
						);
		break;
		...
		case 'general-msg':
			$arr = array(
							'ihc_general_update_msg' => 'Обновление Успешно!',
						);
		break;				
		case 'register':
			$arr = array(
							...
							'ihc_register_terms_c' => 'Примите наши условия',							
		...
		case 'register-msg':
			$arr = array(
							//messages
							'ihc_register_username_taken_msg' => 'Имя пользователя занято',
							'ihc_register_error_username_msg' => 'Неверное имя пользователя',
							'ihc_register_email_is_taken_msg' => 'Email адрес уже есть в системе',
							'ihc_register_invalid_email_msg' => 'Необходимо ввести допустимый  Email Адрес.',
							'ihc_register_emails_not_match_msg' => 'Email Адреса не совпадают!',
							'ihc_register_pass_not_match_msg' => 'Пароль не совпадает',
							'ihc_register_pass_letter_digits_msg' => 'Пароль должен содержать символы и цифры!',
							'ihc_register_pass_let_dig_up_let_msg' => 'Пароль должен содержать символы, цифры и минимум одну заглавную букву!',
							'ihc_register_pass_min_char_msg' => 'Пароль должен содержит минимум {X} символов!',
							'ihc_register_pending_user_msg' => 'Ваша Учетная запись еще не утверждена. Пожалуйста, повторите попытку позже!',
							'ihc_register_err_req_fields' => 'Пожалуйста Заполните все необходимые поля!',
							'ihc_register_err_recaptcha' => 'Captcha Ошибка',
							'ihc_register_err_tos' => 'Ошибка на терминах & условиях',
							'ihc_register_success_meg' => '<h4>Успешная регистрация!</h4>
<br/>',
							'ihc_register_update_msg' => 'Успешно обновлен!',	
		...
		case 'account_page':
			$arr = array(	'ihc_ap_theme' => 'ihc-ap-theme-1',
							...
							'ihc_ap_welcome_msg' => '<span class="iump-user-page-mess-special">Привет</span> <span class="iump-user-page-name"> {last_name} {first_name}</span>,
														<span class="iump-user-page-mess">вы вошли как</span><span class="iump-user-page-mess-special"> {username}</span>
														<div class="iump-user-page-mess"><span>{flag}</span>Участик с  {user_registered}</div>													
														',
							'ihc_account_page_custom_css' => '',
							'ihc_ap_social_plus_message' => '',
							
							'ihc_ap_overview_menu_label' => 'Обзор',
							'ihc_ap_overview_title' => 'Обзор',
							'ihc_ap_overview_msg' => 'Привет,
														Это обзор раздела.
														&nbsp;
														Наслаждайтесь .',	
							'ihc_ap_overview_icon_class' => '',				
							'ihc_ap_overview_icon_code' => 'f015',										
							'ihc_ap_profile_menu_label' => 'Профиль',
							'ihc_ap_profile_title' => 'Профиль',
							'ihc_ap_profile_msg' => '',	
							'ihc_ap_profile_icon_class' => '',				
							'ihc_ap_profile_icon_code' => 'f007',										
							'ihc_ap_subscription_menu_label' => 'Подписка',
							...
							'ihc_ap_social_menu_label' => 'Social Плюс',
							'ihc_ap_social_title' => 'Social Плюс',
							'ihc_ap_social_icon_class' => '',				
							'ihc_ap_social_icon_code' => 'f067',								
							'ihc_ap_social_msg' => '',			
							'ihc_ap_transactions_menu_label' => 'Операции',
							'ihc_ap_transactions_title' => 'Операции',
							'ihc_ap_transactions_msg' => '',	
							'ihc_ap_transactions_icon_class' => '',				
							'ihc_ap_transactions_icon_code' => 'f155',									
							'ihc_ap_orders_menu_label' => 'Заказы',
							'ihc_ap_orders_title' => 'Заказы',
							'ihc_ap_orders_msg' => '',
							'ihc_ap_orders_icon_class' => '',				
							'ihc_ap_orders_icon_code' => 'f0d6',										
							'ihc_ap_membeship_gifts_menu_label' => 'Членство Подарки',
							'ihc_ap_membeship_gifts_title' => 'Членство Подарки',
							...
							'ihc_ap_help_menu_label' => 'Справка',
							'ihc_ap_help_title' => 'Справка',
							'ihc_ap_help_msg' => '',
							'ihc_ap_help_icon_class' => '',				
							'ihc_ap_help_icon_code' => 'f059',								
							'ihc_ap_pushover_notifications_menu_label' => 'Pushover Уведомления',
							'ihc_ap_pushover_notifications_title' => 'Pushover Уведомления',
							...
							'ihc_ap_user_sites_label' => 'Сайты пользователей',
							'ihc_ap_user_sites_title' => 'Сайты пользователей',
...
<p><span class="iump-user-page-mess">и его e-mail адрес : <strong>{user_email}</strong></span></p>
...
<div class="iump-clear"></div>',
		...
		case 'individual_page':
			$arr = array(
							...
							'ihc_individual_page_title' => 'IUMP Отдельные страницы: {username}',
		...
		case 'invoices':
			$arr = array(
							...
							'ihc_invoices_company_field' => '<div><b>Ваше имя компании LLC</b></div>
<div>Уникальный код: #99991239</div>
<div>Адрес компании: ваш Email Адрес</div>',
							'ihc_invoices_bill_to' => '<div><b>Платёжные данные</b></div>
<div><b>Имя: </b>{first_name} {last_name} </div>
<div><b>E-mail: </b>{user_email} </div>
<div><b>Адрес: </b>{CUSTOM_FIELD_addr1}</div>',
							'ihc_invoices_title' => 'Ваш счет заказа',
							'ihc_invoices_template' => '',
							'ihc_invoices_logo' => IHC_URL . 'assets/images/default-logo1.png',
							'ihc_invoices_custom_css' => '',
							'ihc_invoices_footer' => 'Если у вас есть вопросы по поводу этого счета, пожалуйста, свяжитесь с нами!',
			);
			break;
		case 'woo_payment':
			$arr = array(
...
function ihc_native_user_field(){
	...
	$arr = array(
			array( 'display_admin'=>2, 'display_public_reg'=>2, 'display_public_ap'=>2, 'name'=>'user_login', 'label'=>'Имя пользователя', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'confirm_email', 'label'=>'Подтвердите Email', 'type'=>'text', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'first_name', 'label'=>'Имя', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'last_name', 'label'=>'Фамилия', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'user_url', 'label'=>'Веб-сайт', 'type'=>'text', 'native_wp' => 1, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>2, 'display_public_ap'=>1, 'name'=>'pass1', 'label'=>'Пароль', 'type'=>'password', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'pass2', 'label'=>'Подтверждение пароля', 'type'=>'password', 'native_wp' => 1, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'description', 'label'=>'Био инфо', 'type'=>'textarea', 'native_wp' => 1, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'phone', 'label'=>'Телефон', 'type'=>'number', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'addr1', 'label'=>'Адрес 1', 'type'=>'textarea', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'addr2', 'label'=>'Адрес 2', 'type'=>'textarea', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'zip', 'label'=>'Индекс', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'city', 'label'=>'Город', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'thestate', 'label'=>'Государство', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'country', 'label'=>'Страна', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'ihc_avatar', 'label'=>'Аватар', 'type'=>'upload_image', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),			
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'ihc_coupon', 'label'=>'Купон', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'payment_select', 'label'=>'Выберите Payment', 'type'=>'payment_select', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'ihc_country', 'label'=>'Страна', 'type'=>'ihc_country', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'name'=>'tos', 'label'=>'Принять', 'type'=>'checkbox', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>0, 'name'=>'ihc_invitation_code_field', 'label'=>'Код приглашения', 'type'=>'ihc_invitation_code_field', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),	
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'name'=>'ihc_state', 'label'=>'Государство', 'type'=>'ihc_state', 'native_wp' => 1, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>0, 'name'=>'ihc_dynamic_price', 'label'=>'Цена', 'type'=>'ihc_dynamic_price', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),	
	);
							...
							jQuery(document).ready(function() {
								jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ihc-file-upload").uploadFile({
									onSelect: function (files) {		
											...
											if (check_value!="" ){
												alert("Чтобы добавить новое изображение, пожалуйста, удалите предыдущее!");
												return false;
											}	
                							return true;
            						},
								...
								jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ihc-file-upload").uploadFile({
									...
									onSuccess: function(a, response, b, c){
										if (response){
											var obj = jQuery.parseJSON(response);	
											jQuery("#ihc_upload_hidden_'.$rand.'").val(obj.id);
											jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ihc-file-upload").prepend("<div onClick=\"ihc_delete_file_via_ajax("+obj.id+", -1, \'#ihc_fileuploader_wrapp_' . $rand . '\', \'' . $attr['name'] . '\', \'#ihc_upload_hidden_'.$rand.'\');\" class=\'ihc-delete-attachment-bttn\'>Удалить</div>");
											jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ihc-file-upload").prepend("<img src="+obj.url+" class=\'ihc-member-photo\' /><div class=\'ihc-clear\'></div>");	
	...
	if (isset($level_data[$l_id]['access_type']) && $level_data[$l_id]['access_type']=='regular_period'){
		...
		switch ($level_data[$l_id]['access_regular_time_type']){
			case 'D':
				...
				break;
			case 'W':
				$reccurence_time = $level_data[$l_id]['access_regular_time_value'] . ' Неделя';
				$billing = $level_data[$l_id]['billing_limit_num'] . ' Week';
				break;
			case 'M':
				$reccurence_time = $level_data[$l_id]['access_regular_time_value'] . ' Месяц';
				$billing = $level_data[$l_id]['billing_limit_num'] . ' Month';
				break;
			case 'Y':
				$reccurence_time = $level_data[$l_id]['access_regular_time_value'] . ' Год';
...
function ihc_envato_licensing($code=''){
	...
	update_option('ihc_envato_code', 'wpripper.ru');
	return true;
}
...
function ihc_inside_dashboard_error_license($global=FALSE){
	...
	if (!IHCACTIVATEDMODE){
		...
		return "<div class='$class'>Это пробная версия <strong>Ultimate членство Pro</strong> плагина. Пожалуйста, добавьте ваш код покупки в раздел лицензии для включения полной Ultimate членство Pro версии. Проверьте ваш <a href='" . $url . "'>раздел лицензии</a>.</div>";
	}		
	return '';
}
