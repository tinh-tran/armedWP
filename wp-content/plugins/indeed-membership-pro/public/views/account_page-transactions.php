		...
		?>
				...
				foreach ($data['items'] as $k=>$v){
					...
					<tr>
						...
						<td class="manage-column"  style="text-align:left;" data-title="<?php _e('Level', 'ihc');?>">
						...
						<td style="text-transform:capitalize;"  data-title="<?php _e('Payment Type', 'ihc');?>"><?php echo $payment_type;?></td>
