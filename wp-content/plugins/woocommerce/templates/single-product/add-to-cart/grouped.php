...
<form class="cart" action="<?php echo esc_url( get_permalink() ); ?>" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
        ...
        <button type="submit" class="single_add_to_cart_button Button Button_Color_Red Button_Size_Sm product__button"><span class="Button-Text Button-Text_Color_White"><span class="Button-Icon Button-Icon_Basket"></span><?php echo esc_html( $product->single_add_to_cart_text() ); ?></span></button>
