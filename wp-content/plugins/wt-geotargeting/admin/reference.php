			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox">
						<div class="inside">
							<p>
								<b>WT GeoTargeting</b> — плагин для CMS WordPress, позволяющий с помощью Шорткодов
								настраивать геотаргетинг на страницах сайта. Местоположение посетителя определяется на
								основе базы IP-адресов "IpGeoBase".
							</p>
							<p>
								На официальном сайте есть возможность приобрести расширенную версию плагина.
								Расширенная версия позволяет управлять контактами в панели администратора,
								использовать упрощенную форму шорткодом и PHP-методы. Подробности на
								<a href="http://web-technology.biz/cms-wordpress/plugin-wt-geotargeting" target="_blank">официальной странице плагина</a>.
							</p>

							<h3><span style="color: red;"><?php esc_attr_e('Внимание!!!', 'wp_admin_style'); ?></span></h3>
							<p>
								Не смотря на успешность отображения контента ориентированного на местоположение
								пользователей, есть у геотаргетинга и <strong>обратная сторона - погрешность и, в редких
									случаях, невозможность определить местоположение посетителя</strong>. Это достаточно
								важный момент и его всегда стоит учитывать, иначе Вы можете потерять часть потенциальных
								клиентов. Мы рекомендуем реализовать структуру вашего сайта таким образом, что-бы
								пользователь в случае необходимости мог поменять своё месторасположение и найти
							...
							<p>
								...
								<a href="http://ipgeobase.ru/" target="_blank">База IP-адресов "IpGeoBase"</a><br>
								<a href="https://wordpress.org/plugins/wt-geotargeting" target="_blank">Страница плагина на WordPress.org</a><br>
								<a href="http://wt-geotargeting.reformal.ru/" target="_blank">Обсуждение и предложения по доработке плагина</a><br>
								<a href="https://vk.com/agency_web_technology" target="_blank">Группа Вконтакте</a>
							</p>
						</div>
